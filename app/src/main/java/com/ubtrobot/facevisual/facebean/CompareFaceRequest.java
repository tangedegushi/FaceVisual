...
public class CompareFaceRequest {
    ...
    public class Builder{
        ...
        public CompareFaceRequest build(){
            if ((TextUtils.isEmpty(ImageA) && TextUtils.isEmpty(UrlA))||(TextUtils.isEmpty(ImageB) && TextUtils.isEmpty(UrlB))) {
                throw new RuntimeException("人脸比对必须提供相关的人脸信息：ImageA or UrlA 或者 ImageB or UrlB");
            }
